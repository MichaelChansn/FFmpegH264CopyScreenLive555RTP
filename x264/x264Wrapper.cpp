...
int x264Wrapper::Initialize(int iWidth, int iHeight, int iRateBit, int iFps)
{
...
//FILE* ff1 ;
int x264Wrapper::Encode(unsigned char* szYUVFrame, TNAL*& pNALArray, int& iNalNum)
{
